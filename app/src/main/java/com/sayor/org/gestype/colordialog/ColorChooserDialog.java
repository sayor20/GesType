  ...
  /*  @Override
    ...
    */
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mCircleSize = getResources().getDimensionPixelSize(com.afollestad.materialdialogs.commons.R.dimen.md_colorchooser_circlesize);
        final Builder builder = getBuilder();

        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .title(getTitle())
                .autoDismiss(false)
                .customView(com.afollestad.materialdialogs.commons.R.layout.md_dialog_colorchooser, false)
        ...
        mGrid = (GridView) v.findViewById(com.afollestad.materialdialogs.commons.R.id.grid);

        if (builder.mAllowUserCustom) {
            mSelectedCustomColor = preselectColor;
            mColorChooserCustomFrame = v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorChooserCustomFrame);
            mCustomColorHex = (EditText) v.findViewById(com.afollestad.materialdialogs.commons.R.id.hexInput);
            mCustomColorIndicator = v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorIndicator);
            mCustomSeekA = (SeekBar) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorA);
            mCustomSeekAValue = (TextView) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorAValue);
            mCustomSeekR = (SeekBar) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorR);
            mCustomSeekRValue = (TextView) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorRValue);
            mCustomSeekG = (SeekBar) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorG);
            mCustomSeekGValue = (TextView) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorGValue);
            mCustomSeekB = (SeekBar) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorB);
            mCustomSeekBValue = (TextView) v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorBValue);

            if (!builder.mAllowUserCustomAlpha) {
                v.findViewById(com.afollestad.materialdialogs.commons.R.id.colorALabel).setVisibility(View.GONE);
    ...
    private void invalidate() {
        if (mGrid.getAdapter() == null) {
            ...
            mGrid.setSelector(ResourcesCompat.getDrawable(getResources(), com.afollestad.materialdialogs.commons.R.drawable.md_transparent, null));
    ...
    public static class Builder implements Serializable {
        ...
        public <ActivityType extends AppCompatActivity> Builder(@NonNull Context context, @StringRes int title) {
